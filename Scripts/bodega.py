...
early_link = base_url + '/products/air-force-1-07-lv8-7?variant=31832991858762'
shoe_size = '11'
...
def get_shoe_product_payload(soup):
    ...
    payload = {
        'id': product_id,
        'properties[bot - key]': '2486317285104'
    }
...
def add_to_cart(early_link, shoe_size): # TODO: support for products other than shoes
    ...
    response = session.post(base_url + '/499112/checkouts/7464299f614ad7c3a46bdcc04df9eece?locale=en', data=payload)
